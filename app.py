...
with tab1:
  ...
  if btn_predict:
    ...
    if prediction == 0:
      ...
      st.error("heart disease level 2!")
    elif prediction == 3:
...
with tab2:
  ...
  st.download_button(label="**Download CSV hungarian**", data=pd.read_csv("data/hungarian.csv").to_csv(index=False), file_name="hungarian.csv", mime="text/csv", help="Click here to download the CSV hungarian.")
  ...
  if uploaded_file is not None:
    ...
    for prediction in predictions:
      if prediction == 0:
        results.append(":green[**Healthy**]")
      elif prediction == 1:
        results.append(":orange[**Heart disease level 1**]")
      elif prediction == 2:
        results.append(":orange[**Heart disease level 2**]")
      elif prediction == 3:
        results.append(":red[**Heart disease level 3**]")
      elif prediction == 4:
        results.append(":red[**Heart disease level 4**]")
